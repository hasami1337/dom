...
// 17
   ...
   //    let bukv = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
   //    let randomString = '';
   //    for (let i = 0; i < length; i++) {
   //      let randomIndex = Math.floor(Math.random() * bukv.length);
   //      randomString += bukv[randomIndex];
   //    }
   //    return randomString;
   //  }
   ...
   //    let shufflstr = shuffleString(input.value);
   ...
   //    result.textContent = 'температура в цельсиях: ' + celsius.toFixed(2);
   //  }
   // =======================================================================
   // 22
